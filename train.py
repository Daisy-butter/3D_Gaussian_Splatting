...
# import sys
# from scenes import Scene, GaussianModel
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    if not SPARSE_ADAM_AVAILABLE and opt.optimizer_type == "sparse_adam":
        sys.exit("Sparse Adam not installed, please install with pip install [3dgs_accel].")
        ...
        with torch.no_grad():
            ...
            if iteration % 10 == 0:
                ...
                if tb_writer:
                    ...
                    tb_writer.add_scalar("L1/train", Ll1.item(), iteration)
                    tb_writer.add_scalar("SSIM/train", ssim_value.item(), iteration)
